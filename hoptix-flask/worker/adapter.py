...
When indicating items, format them like this: [Item ID]_[Size ID]. For example, a Medium Misty Freeze has Item ID 16 and medium corresponds to a size ID of 2, so it would result in 16_2. For all rows where you list out items, like rows and 19, format the items like this.
